...
ggplot(data1_fixed, aes(xPos, yPos, fill= timeToCrash)) +
  ...
  coord_cartesian(xlim = c(-120, 120), clip="on") +
...
ggsave(path = "/Users/daoktar/CODE/ThreeBodyBot_for_collision_visuals/heatmap_copy/", filename = "rheatmap2.png", width = 12, height = 16, device='png', dpi=1200)
